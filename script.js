document.addEventListener('DOMContentLoaded', async () => {
  ...
  // === Attach Faction Button Listeners AFTER DOM Loaded ===
  function attachFactionModalListeners() {
  ...
  // Attach faction modal buttons AFTER DOM is ready
  attachFactionModalListeners();

  // Disable New Army until initialization completes
